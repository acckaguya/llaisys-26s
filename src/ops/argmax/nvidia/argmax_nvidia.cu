...
void argmax(
    ...
    case LLAISYS_DTYPE_F32:
        launch<float>(max_idx, max_val, vals, numel, cuda_stream);
        break;
    case LLAISYS_DTYPE_F16:
        launch<__half>(max_idx, max_val, vals, numel, cuda_stream);
        break;
    case LLAISYS_DTYPE_BF16:
        launch<__nv_bfloat16>(max_idx, max_val, vals, numel, cuda_stream);
        break;
    default:
