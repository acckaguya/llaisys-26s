...
void rope(
    ...
    case LLAISYS_DTYPE_F32:
        launch<float>(out, in, pos_ids, seq_len, n_heads, head_dim, theta, mc_stream);
        break;
    case LLAISYS_DTYPE_F16:
        launch<__half>(out, in, pos_ids, seq_len, n_heads, head_dim, theta, mc_stream);
        break;
    case LLAISYS_DTYPE_BF16:
        launch<maca_bfloat16>(out, in, pos_ids, seq_len, n_heads, head_dim, theta, mc_stream);
        break;
    default:
