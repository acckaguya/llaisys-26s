...
void launch(
    ...
    // 用同步分配代替流序分配，语义等价且兼容性最稳
    auto error = mcMalloc(reinterpret_cast<void **>(&scores), score_count * sizeof(float));
...
void self_attention(
    ...
    case LLAISYS_DTYPE_F32:
        return launch<float>(
            ...
            n_kv_heads, q_dim, v_dim, scale, mc_stream
        );
