from ctypes import (
    Structure, POINTER, c_void_p, c_char_p,
    c_size_t, c_float, c_int, c_int64
)
...
def load_qwen2(lib):
    ...
    lib.llaisysQwen2ModelLoadWeight.argtypes = [
        llaisysQwen2Model_t, c_char_p, c_void_p, c_size_t
    ]
    lib.llaisysQwen2ModelLoadWeight.restype = None

    lib.llaisysQwen2ModelLoadWeightCount.argtypes = [llaisysQwen2Model_t]
    lib.llaisysQwen2ModelLoadWeightCount.restype = c_size_t

    lib.llaisysQwen2ModelResetCache.argtypes = [
            llaisysQwen2Model_t, c_size_t
        ]
